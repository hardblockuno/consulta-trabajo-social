      ...
      <div className="section-shell grid min-h-[68svh] items-center gap-8 py-8 sm:py-12 lg:grid-cols-[1fr_0.78fr]">
        <div className="max-w-3xl text-white">
          ...
          <div className="mt-8 flex flex-wrap gap-2 text-sm font-bold text-white">
            {['Online', '45 min', 'Datos mínimos'].map((item) => (
        ...
        <div className="rounded-lg border border-white/25 bg-white p-5 shadow-soft">
          <div>
            <p className="text-sm font-bold text-brand-700">Próximas horas</p>
            <h2 className="mt-1 text-2xl font-black text-slate-950">Profesionales disponibles</h2>
          </div>
